...
- `sitemap.xml` — added `people-also-ask.html` entry (2026-05-19); updated `lastmod` for `/`, `/blog/`, `/blog/archives.html`, `/now/`, `/feed.xml`, and `pi-backups-raspberry-pi.html` to 2026-05-19
